using SocomTrainingPlatform.Enums;
using System;
using System.Collections.Generic;
using System.Linq;
using System.Threading.Tasks;

namespace SocomTrainingPlatform.Services
{
        ...
        public static string ShowAlert(Alerts obj, string message)
        {
            ...
            switch (obj)
            {
                ...
                case Alerts.Danger:
                    ...
                    break;
                case Alerts.Info:
                    alertDiv = "<div class='alert alert-info alert-dismissable' id='alert'><button type='button' class='close' data-dismiss='alert'>×</button> " + message + "</a>.</div>";
                    break;
                case Alerts.Warning:
